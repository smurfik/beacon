  ...
  Table: React.createClass({
    ...
    render: function () {
      ...
      for (var i = 0; i < this.props.tableRows.length; i++) {
        rows.push(React.createElement(NewRow, { id: i, key: i, element: this.props.tableRows[i], columns: this.props.tableRows[i].columns, updateElementText: this.updateElementText, changeCellToForm: this.props.changeCellToForm }));
      }
  ...
  NewRow: React.createClass({
    ...
    render: function () {
      ...
      for (var i = 0; i < this.props.columns.length; i++) {
        columns.push(React.createElement(TableCell, { id: i, key: i, element: this.props.columns[i], text: this.props.columns[i].text, updateElementText: this.props.updateElementText, changeCellToForm: this.changeCellToForm }));
      }
  ...
  TableCell: React.createClass({
    ...
    render: function () {
      ...
      if (this.state.active == false) {
        ...
        cellType = React.createElement(FormBank[this.props.element.cellType], { text: "Now I'm a form", updateElementText: this.updateElementText })
...
var FormBuilder = React.createClass({
  ...
  render: function () {
    return React.createElement(
      'div',
      null,
      React.createElement(Builder, { formElements: this.state.currentForm, deleteElement: this.deleteElement, moveElementUp: this.moveElementUp, moveElementDown: this.moveElementDown, updateElementText: this.updateElementText, addRow: this.addRow, addColumn: this.addColumn, changeCellToForm: this.changeCellToForm }),
