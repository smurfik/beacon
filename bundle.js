  ...
  Table: React.createClass({
    ...
    render: function () {
      ...
      for (var i = 0; i < this.props.tableRows.length; i++) {
        rows.push(React.createElement(NewRow, { key: i, element: this.props.tableRows[i], columns: this.props.tableRows[i].columns, updateElementText: this.updateElementText, addTableElement: this.props.addTableElement }));
      }
  ...
  NewRow: React.createClass({
    ...
    render: function () {
      ...
      for (var i = 0; i < this.props.columns.length; i++) {
        columns.push(React.createElement(TableCell, { key: i, element: this.props.columns[i], text: this.props.columns[i].text, updateElementText: this.props.updateElementText, addTableElement: this.props.addTableElement }));
      }
